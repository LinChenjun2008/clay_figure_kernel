...
#define SELECTOR_KERNEL_CODE64 ((1 << 3) | TI_GDT | RPL0) /* 代码段 */
#define SELECTOR_KERNEL_DATA64 ((2 << 3) | TI_GDT | RPL0) /* 数据段 */

#define SELECTOR_USER_DATA64 ((3 << 3) | TI_GDT | RPL3) /* 用户数据段 */
#define SELECTOR_USER_CODE64 ((4 << 3) | TI_GDT | RPL3) /* 用户代码段 */
